...
const TEXTOS = {
  es: {
    ...
    desc: 'Analizamos tu perfil de Google Business frente a tus 2 competidores más cercanos. Descubre los gaps que te impiden estar en el Top 3 de Maps y en las respuestas de ChatGPT y Gemini.',
    ...
    competidores_desc: 'Escribe el nombre de tus 2 competidores más cercanos en Google Maps. Si no los conoces, los detectaremos automáticamente.',
    ...
    compara_negocio: 'Comparamos tu negocio con los 2 competidores más cercanos en tu zona',
  ...
  en: {
    ...
    desc: 'We analyze your Google Business profile against your 2 nearest competitors. Discover the gaps preventing you from being in the Top 3 of Maps and ChatGPT and Gemini responses.',
    ...
    competidores_desc: 'Write the name of your 2 nearest competitors on Google Maps. If you don\'t know them, we\'ll detect them automatically.',
    ...
    compara_negocio: 'We compare your business with the 2 nearest competitors in your area',
